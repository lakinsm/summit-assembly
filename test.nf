...
process QualityControl {
    ...
    output:
        set dataset_id, file("${dataset_id}_1P.fastq"), file("${dataset_id}_2P.fastq") into (paired_fastq)
    ...
    /usr/lib/jvm/java-7-openjdk-amd64/bin/java -jar ${TRIMMOMATIC}/trimmomatic-0.36.jar \
        ...
        ${dataset_id}_2P.fastq ${dataset_id}_2U \
        -trimlog ${dataset_id}.trimmomatic.stats.log \
